...
tariff_rates = {
    'Andhra Pradesh - Visakhapatnam': {
        ...
        'industrial': 7.65,   # Tariff rate for industrial consumers in Maharashtra
    ...
    'Assam - Guwahati': {
        ...
        'commercial': 8.0,   # Tariff rate for commercial consumers in Gujarat
        # Add more categories if needed
    },
    ...
    'Karnataka - Bengaluru': {
        ...
        'industrial':6.90  ,   # Tariff rate for industrial consumers in Gujarat
        'commercial': 8.0,   # Tariff rate for commercial consumers in Gujarat
        # Add more categories if needed
    },
    ...
    'Maharashtra - Aurangabad': {
        ...
        'commercial': 8.27,   # Tariff rate for commercial consumers in Gujarat
        # Add more categories if needed
    },
    ...
    'West Bengal - Asansol': {
        'residential':4.62,  # Tariff rate for residential consumers in Gujarat
        'industrial':  4.37,   # Tariff rate for industrial consumers in Gujarat
        'commercial': 4.92,   # Tariff rate for commercial consumers in Gujarat
        # Add more categories if needed
    },
